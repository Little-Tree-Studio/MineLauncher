                                ...
                                ft.Row(
                                    [
                                        ft.OutlinedButton(
                                            "设为当前",
                                            icon=ft.Icons.CHECK,
                                            on_click=lambda _, p=item["path"]: self._set_current(p),
                                        ),
                                        ft.OutlinedButton(
                                            "打开",
                                            icon=ft.Icons.FOLDER_OPEN,
                                            on_click=lambda _, p=item["path"]: self._open_path(p),
                                        ),
                                        ft.OutlinedButton(
                                            "命名",
                                            icon=ft.Icons.DRIVE_FILE_RENAME_OUTLINE,
                                            on_click=lambda _, p=item["path"]: self._show_rename_dialog(p),
                                        ),
                                        ft.OutlinedButton(
                                            "删除",
                                            icon=ft.Icons.DELETE_OUTLINE,
                                            on_click=lambda _, p=item["path"]: self._show_delete_dialog(p),
                                        ),
                                    ],
                                    spacing=8,
                                ),
